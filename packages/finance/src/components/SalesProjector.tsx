...
export const SalesProjector: React.FC<SalesProjectorProps> = ({
  ...
  const [distributionPattern, setDistributionPattern] = useState<'linear' | 'frontloaded' | 'backloaded' | 'bell'>('bell');
          ...
          <div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <p className="text-2xl font-bold">${projection.metrics.totalRevenue.toLocaleString()}</p>
              </div>
              <div className="bg-purple-50 p-4 rounded-lg">
                <p className="text-sm text-gray-500">Absorción Promedio</p>
                <p className="text-2xl font-bold">{projection.metrics.averageAbsorptionRate.toFixed(1)}%</p>
              </div>
            </div>
          ...
          <div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <p className="text-2xl font-bold">
                  ${projection.cashFlow[projection.cashFlow.length - 1].cumulativeCashFlow.toLocaleString()}
                </p>
              </div>
              <div className="bg-purple-50 p-4 rounded-lg">
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between border-b pb-2">
                    ...
                    <span className="font-medium">${projection.metrics.totalRevenue.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between border-b pb-2">
                  ...
                  <div className="flex justify-between border-b pb-2">
                    ...
                    <span className="font-medium">{projection.metrics.averageAbsorptionRate.toFixed(1)}%</span>
                  </div>
                </div>
              </div>
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between border-b pb-2">
                    ...
                    <span className="font-medium">{getDistributionPatternName(distributionPattern)}</span>
                  </div>
                </div>
              </div>
            </div>
...
function getDistributionPatternName(pattern: 'linear' | 'frontloaded' | 'backloaded' | 'bell'): string {
  const names = {
    linear: 'Lineal',
