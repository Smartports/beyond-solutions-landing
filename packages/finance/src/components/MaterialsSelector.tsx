      ...
      <div className="mb-6">
        <button
          className={`px-4 py-2 rounded-lg transition-all ${
            isCustomMode ? 'bg-blue-500 text-white' : 'bg-gray-200 hover:bg-gray-300 text-gray-800'
          }`}
      ...
      {isCustomMode && (
        <div className="border border-gray-200 rounded-lg p-4 mb-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            En un proyecto real, aquí podrías seleccionar materiales específicos para cada
            categoría.
          </p>
