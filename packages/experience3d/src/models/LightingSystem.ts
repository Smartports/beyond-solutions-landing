import { Scene, DirectionalLight, ShadowGenerator, Vector3, Color3, HemisphericLight, SpotLight, PointLight } from '@babylonjs/core';
...
export class LightingSystem {
  ...
  constructor(private viewer: ImmersiveViewer, private options: LightingSystemOptions = {}) {
