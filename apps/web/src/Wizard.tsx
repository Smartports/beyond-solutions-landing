...
const Wizard: React.FC<WizardProps> = ({ onComplete, initialData }) => {
  ...
  const saveCurrentState = async () => {
    ...
    try {
      ...
      // Use the onComplete callback if provided, otherwise just finish
      if (onComplete) {
  ...
  const handleNext = () => {
    ...
    if (state.currentStep < WIZARD_STEPS.length - 1) {
      ...
      // Si es el último paso, guardamos y completamos
      saveCurrentState();
    }
  };
    ...
    <div className="max-w-4xl mx-auto p-4 pt-8">
      ...
      <div className="bg-white dark:bg-zinc-800 rounded-lg shadow-lg p-6 mb-6">
        ...
        >
          ...
          <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
            Esta información nos ayuda a personalizar las recomendaciones y cálculos para tu
            proyecto.
          </p>
        </StepContainer>
        ...
        >
          ...
          <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
            El tipo de proyecto afecta los cálculos de costos, regulaciones aplicables y
      ...
      <div className="text-sm text-gray-500 dark:text-gray-400 flex items-center justify-end gap-2">
        {state.isSaving ? (
          <>
            <svg
              className="animate-spin h-4 w-4 text-primary-800 dark:text-accent-100"
          ...
          <>
            ...
            <span>
              ...
              {state.lastSaved.toLocaleTimeString(undefined, {
                hour: '2-digit',
                minute: '2-digit',
              })}
            </span>
