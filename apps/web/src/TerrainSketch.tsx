    ...
    <div className={`terrain-sketch ${className}`}>
      ...
      <div className="relative border border-gray-300 dark:border-gray-700 rounded-lg overflow-hidden">
        ...
        <div className="absolute bottom-4 left-4 bg-white dark:bg-gray-800 p-2 rounded-md shadow text-sm">
          ...
          {points.length > 2 && (
            <p>
              {isDrawing ? 'Haz clic en el primer punto para cerrar' : 'Polígono cerrado'}
            </p>
          )}
        </div>
      </div>
      ...
      <div className="mt-4 text-sm text-gray-600 dark:text-gray-400">
        <p>
          <strong>Instrucciones:</strong> Haz clic para añadir puntos. Cierra el polígono haciendo clic en el primer punto.
          Arrastra los puntos para ajustar la forma. Usa la rueda del ratón para hacer zoom.
        </p>
      </div>
    </div>
  );
